  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
      <div className="w-full h-full flex flex-row justify-center items-center">
        ...
        />
        <button className="bg-amber-950 text-orange-50 font-bold py-1.5 lg:py-2 px-2 flex items-center justify-center rounded-r-lg border-2 border-amber-950 hover:bg-amber-800">
