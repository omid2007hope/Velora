					...
					<div className="flex items-center justify-center bg-orange-200 px-6 py-10 text-amber-950 lg:px-16 lg:py-16">
						<div className="max-w-md space-y-4">
							...
							<p className="text-sm text-amber-800 sm:text-base">
								Upgrade your style with timepieces
								that feel polished, modern, and easy
								to wear every day. Our watch edit
								leans into clean silhouettes,
								wearable tones, and statement pieces
								that work with both casual and
								dressed-up looks.
							</p>

							<p className="text-sm text-amber-900 sm:text-base">
								Whether you prefer a minimal face or
								a bolder profile, the collection is
								meant to add personality without
								overpowering the rest of your
								outfit.
							</p>
