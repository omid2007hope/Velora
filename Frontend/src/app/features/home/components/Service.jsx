			...
			<div className="grid items-center gap-10 lg:grid-cols-2">
				<div>
					...
					<p className="mt-4 text-base text-amber-900">
						Thoughtful support, transparent policies, and
						reliable fulfillment are part of the experience we
						want every Velora customer to expect. The goal is a
						shopping journey that feels calm, clear, and easy to
