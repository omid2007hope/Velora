          ...
          <div className="flex h-full max-w-4xl flex-col justify-between">
            ...
            <div className="space-y-6 lg:space-y-4">
              ...
              <p className="ml-0 mr-10 text-base leading-7 text-amber-900/90 sm:ml-8 sm:mr-10 lg:ml-0 lg:mr-10">
                ...
                details that work together across workdays, weekends, and travel.
                The focus stays on versatile style, clear choices, and pieces
                that can move from one outfit to the next without friction.
              </p>
            </div>
